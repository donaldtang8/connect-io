...
class User
{
    ...
    public function isFriend($username_to_check)
    {
        ...
        // check if username is in friend array or check yourself
    ...
    public function removeFriend($user_to_remove)
    {
        ...
        // get friend array so we can remove the 'user to remove' from array
        $query = mysqli_query($this->con, "SELECT friend_array FROM users WHERE username='$user_to_remove'");
        $row = mysqli_fetch_array($query);
        $friend_array_username = $row['friend_array'];
        // replace the user array with new user array with user removed
    ...
    public function getMutualFriends($user_to_check)
    {
        ...
        $user_array_explode = explode(",", $user_array);    // split up string wherever it findsi comma
    ...
    {
        $username = $this->user['username'];
        $request_count_query = mysqli_query($this->con, "SELECT * FROM friend_requests WHERE user_to='$username'");
        return mysqli_num_rows($request_count_query);
    }
}
