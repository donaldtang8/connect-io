...
if (isset($_FILES['image']['name'])) {
    ...
    $uploaddir = $_SERVER['DOCUMENT_ROOT'] . '/social-media/assets/images/profile_pics';
    //Set File name	
...
<div class="container">
    ...
    <div class="upload_container">
        ...
        <!-- <form action="upload.php" method="post" enctype="multipart/form-data">
            <div class="heading-1">Choose Image</div>
            <input class="upload_file" type="file" id="image" name="image" /><br /><br />
        <div class="custom-file">
            <input type="file" class="custom-file-input upload_file" id="image" name="image">
            <label class="custom-file-label" for="customFile">Choose file</label>
        </div>
        <input class="btn btn-primary submit_file" type="submit" value="Submit" />
        </form><br /><br /> -->

        <form action="upload.php" method="post" enctype="multipart/form-data">
            <div class="file-upload-wrapper" data-text="Select file">
                <input type="file" class="file-upload-field" id="image" name="image" value="">
            </div>
            <input class="btn btn-primary submit_file" type="submit" value="Submit" />
        </form>
    ...
    if ($imgSrc) { //if an image has been uploaded display cropping area
        ...
        <div id="CroppingContainer" style="width:80rem; max-height:600px; position:relative; overflow:hidden; z-index:2001;">

            <div id="CroppingArea" style="width:50rem; max-height:100%; position:relative; overflow:hidden; margin:4rem 0px 4rem 0px; float:left;">
